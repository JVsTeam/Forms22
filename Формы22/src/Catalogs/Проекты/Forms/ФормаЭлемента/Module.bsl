...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Руководитель") Тогда
			...
			Если Не Параметры.Руководитель = Параметры.Руководитель.Подразделение.Руководитель 
			и не Параметры.Руководитель.Подразделение.Руководитель = Справочники.ФизическиеЛица.ПустаяСсылка()  Тогда
				Начальник = Объект.СписокДляСогласования.Добавить();
				Начальник.Сотрудник = Параметры.Руководитель.Подразделение.Руководитель;
			КонецЕсли;
	КонецЕсли;
